...
const GeoLayout bob_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 0, 1300, -716, bob_dl_Cube_001_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_ALPHA, 76, 647, -716, bob_dl_fireplace_mesh_layer_4),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, -2986, -1003, -716, bob_dl_textbox_1_002_mesh_layer_5),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
