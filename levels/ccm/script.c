...
const LevelScript level_ccm_entry[] = {
	...
	AREA(1, ccm_area_1),
		...
		OBJECT(MODEL_SOPHIE, 443, 152, -43, 0, -46, 0, (165 << 16), bhvSophie),
		OBJECT(MODEL_SOPHIE, 97, 100, -7917, 0, -46, 0, (162 << 16), bhvSophie),
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, 1, 100, -8184, 0, 0, 0, (0xB << 24) | (0xB << 16), bhvDoorWarp),
		OBJECT(MODEL_NONE, 0, 200, 0, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, 0, 200, 0),
		TERRAIN(ccm_area_1_collision),
		MACRO_OBJECTS(ccm_area_1_macro_objs),
		SET_BACKGROUND_MUSIC(0x00, SEQ_STREAMED_FISHING),
