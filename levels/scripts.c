...
const LevelScript level_main_scripts_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_PSYCH_KILLROCK,          psych_killrock_geo), 
    LOAD_MODEL_FROM_GEO(MODEL_SOPHIE,                  sophie_geo),
    LOAD_MODEL_FROM_GEO(MODEL_PSYCH_GRABNEEDLE,        psych_getneedle_geo),
    LOAD_MODEL_FROM_GEO(MODEL_PSYCH_WALKNEEDLE,        psych_walkneedle_geo),
