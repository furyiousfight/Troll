...
const LevelScript level_main_scripts_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_DREXPLOSION,             DRExplosion_geo),
    LOAD_MODEL_FROM_GEO(MODEL_NETHER,                  nether_geo),   
    LOAD_MODEL_FROM_GEO(MODEL_FRISK_FRONT,             FriskFront_geo),
    LOAD_MODEL_FROM_GEO(MODEL_FRISK_BACK,              FriskBack_geo),
    LOAD_MODEL_FROM_GEO(MODEL_FRISK_LEFT,              FriskLeft_geo),
    LOAD_MODEL_FROM_GEO(MODEL_FRISK_RIGHT,             FriskRight_geo),  
    LOAD_MODEL_FROM_GEO(MODEL_PSYCH_SIT,               psychiatristsit_geo),
    LOAD_MODEL_FROM_GEO(MODEL_PSYCH_STAND,             psych_stand_geo),
    LOAD_MODEL_FROM_GEO(MODEL_PSYCH_WALK,              psych_walk_geo),
    LOAD_MODEL_FROM_GEO(MODEL_FIREPLACE,               fireplace_geo),
