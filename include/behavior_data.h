...
extern const BehaviorScript bhvDRExplosion[];
extern const BehaviorScript bhvNetherPortal[];
...
extern const BehaviorScript bhvUndertaleWarp[];
extern const BehaviorScript bhvBuilding[];
