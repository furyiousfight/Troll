...
COURSE_ACTS(COURSE_JRB, _("   PNF-404"),
       _("pikmin stuff")    , _("CAN THE EEL COME OUT TO PLAY?") , _("TREASURE OF THE OCEAN CAVE"),
       _("RED COINS ON THE SHIP AFLOAT")  , _("BLAST TO THE STONE PILLAR")     , _("THROUGH THE JET STREAM"))

COURSE_ACTS(COURSE_CCM, _("   Sophie Normal Inc."),
       _("come on in")             , _("LI'L PENGUIN LOST")             , _("BIG PENGUIN RACE"),
