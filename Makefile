...
SRC_DIRS += src src/boot src/game src/engine src/audio src/menu src/buffers actors levels bin data assets asm lib sound bin/animation
...
$(BUILD_DIR)/bin/animation/%.o: OPT_FLAGS := -g
